...
public class StoryCon {
    ...
    //    === UI ===
       // ===== Scenes =====
    private @NotNull VBox createViewersBox(Map<User, LocalDateTime> viewersMap) {
    ...
    private @NotNull HBox createViewerItem(User viewer, LocalDateTime viewTime) {
    ...
    private @NotNull HBox createStoryItem(Story story) {
    ...
    private @NotNull VBox createStoryTextBox(Story story) {

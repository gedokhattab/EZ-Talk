...
public class ChatCon {
    ...
    private @NotNull VBox createSeenByBox(Map<String, LocalDateTime> viewersMap) {
    ...
    private @NotNull HBox createSeenByItem(User viewer, LocalDateTime viewTime) {
    ...
    //    === Chats ===
    private @NotNull VBox vBoxChatItemUi(ChatRoom room) {
        Label nameLabel = new Label();
        if (room.getType().equals(ChatRoomType.ONE_TO_ONE)) {
    ...
    private @NotNull HBox hBoxChatItemUi(ChatRoom room) {
        ImageView avatar;
    ...
    private @NotNull HBox hBoxSearchedMessagetoChatsBoxUI(VBox textBox) {
    ...
    private @NotNull HBox hBoxSearchedContacttoChatsBoxUI(ImageView view, VBox textBox) {
        final String baseStyle = "-fx-background-color: #0F3338; -fx-background-radius: 8;";
        final String hoverStyle = "-fx-background-color: #1E6670; -fx-background-radius: 8;";
    ...
    //    === Message ===
    private @NotNull HBox createMessageHBox(Message msg, String roomId, boolean isSender) {
    ...
    private @NotNull VBox createMessageVBox(Message msg, String roomId, boolean isSender) {
    ...
    private @NotNull Label createSenderLabel(Message msg, boolean isSender) {
    ...
    private @NotNull Label createReplyLabel(Message msg, boolean isSender) {
    ...
    private @NotNull Label createMessageLabel(Message msg, String roomId, boolean isSender) {
    ...
    private @NotNull HBox createFooter(Message msg, boolean isSender) {
    ...
    //    === Buttons ===
    private @NotNull Button imageButton(String path) {
